...
export default async function BodyPage({ searchParams }: { searchParams: Promise<{ edit?: string; saved?: string }> }) {
  ...
  const editRow = editId > 0 ? rows.find((r: any) => r.id === editId) : null;
