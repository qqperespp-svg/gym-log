...
import { deleteBodyAction, saveBodyAction, updateBodyAction } from "@/actions/body";
                ...
                {rows.map((r) => (
                  <tr key={r.id}>
                    ...
                    <td className="flex gap-1">
                      ...
                      <form
                        action={deleteBodyAction.bind(null, r.id)}
                        className="inline"
                        onSubmit={(e) => {
                          if (!window.confirm("Usunąć pomiar?")) e.preventDefault();
                        }}
                      >
                        <button
                          type="submit"
