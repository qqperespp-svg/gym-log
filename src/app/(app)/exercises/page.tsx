...
export default async function ExercisesPage() {
  ...
  return (
    <div className="space-y-7">
      <header>
        <p className="eyebrow">Ponad 200 ruchów</p>
        <h1 className="page-title">Biblioteka ćwiczeń</h1>
        <p className="mt-2 text-sm text-slate-500">Przeszukuj katalog lub dodawaj własne ćwiczenia.</p>
      </header>
      <ExerciseLibrary exercises={items} />
    </div>
  );
}
