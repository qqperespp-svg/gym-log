...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const accent = (["lime", "sky", "violet", "rose", "amber", "emerald", "cyan", "fuchsia", "orange", "teal", "indigo", "gold"] as const).includes(settings?.accent as never)
    ? (settings?.accent as "lime" | "sky" | "violet" | "rose" | "amber" | "emerald" | "cyan" | "fuchsia" | "orange")
    : "lime";
  return (
    <div className="min-h-screen bg-[#0b0f14] text-slate-200">
      ...
      <main className="min-h-screen px-4 pb-24 pt-20 sm:px-7 lg:ml-72 lg:px-10 lg:pb-12 lg:pt-9 xl:px-12">
